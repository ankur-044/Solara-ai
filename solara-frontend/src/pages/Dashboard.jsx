...
export default function Dashboard() {
  ...
  const fetchRealData = async (targetCity) => {
    ...
    try {
      ...
      if (res.data?.error) {
        console.log("Soft backend warning");
        return;
      }
      ...
      // KEEP UI ALIVE ON MOBILE
      if (!data) {

        setData({
          location: targetCity.toUpperCase(),
          lat: 0,
          lon: 0,
          irradiance: 0,
          uv_index: 0,
          ...
          device_plan: [
            {
              ...
              reason: "Render backend waking up"
            }
          ],
          ...
          analysis: {
            confidence: 0,
            alerts: [
              "Backend waking from sleep mode"
            ]
          }
        });
      }
  ...
  if (error) return (
    <div className="h-screen bg-black flex flex-col items-center justify-center text-red-500 font-mono p-10 text-center">
      ...
      <p className="text-gray-500 mt-2 italic text-xs uppercase mb-10">
        {error}
      </p>

      <button
        onClick={() => fetchRealData(city)}
        className="border border-red-500 px-10 py-4 hover:bg-red-500 hover:text-white transition-all text-white uppercase text-xs tracking-[0.3em]"
      >
        Retry Satellite Sync
      </button>
    </div>
  );
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-12 gap-8 border-b border-gray-200 dark:border-white/10 pb-10">
          ...
          <div className="w-full md:w-1/2">
            ...
            <form onSubmit={handleSearch} className="relative group">
              ...
              <Search
                className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-solar transition-colors"
                size={20}
              />
          ...
          <div className="text-center md:text-right">
            ...
            <h1 className="text-4xl md:text-5xl font-black italic uppercase tracking-tighter leading-none text-black dark:text-white">
              {t('cmd_dash')}
            </h1>
            ...
            <p className="text-solar text-[10px] tracking-[0.5em] flex items-center justify-center md:justify-end gap-2 mt-4 uppercase font-bold">
              <MapPin size={12}/>
              {data.location} | GPS: {data.lat?.toFixed(4)}, {data.lon?.toFixed(4)}
            </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/2 p-8 flex flex-col items-center justify-center relative group">
            ...
            <div className="absolute top-8 left-8 flex items-center gap-2">
              ...
              <h3 className="text-[10px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-[0.4em]">
                Solar Clock
              </h3>
            </div>
            ...
            <div className="w-52 h-52 rounded-full border-[14px] border-gray-200 dark:border-white/5 flex flex-col items-center justify-center relative shadow-sm">
              ...
              <p className="text-5xl font-black italic text-black dark:text-white">
                {data.solar_windows?.[0]?.start || "N/A"}
              </p>

              <p className="text-[10px] text-solar font-bold mt-2 uppercase tracking-widest">
          ...
          <div className="lg:col-span-2 border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/2 p-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {data.device_plan?.map((dev, i) => (
                ...
                <div
                  key={i}
                  className="p-6 border border-gray-200 dark:border-white/5 bg-white dark:bg-black/60 hover:border-solar transition-all flex justify-between items-center group"
                >

                  <div>

                    <p className="font-black text-sm uppercase italic text-black dark:text-gray-300 group-hover:text-solar transition-colors">
                      {dev.device}
                    </p>

                    <p className="text-[10px] text-gray-500 uppercase tracking-tighter mt-2 leading-tight">
                      {dev.reason}
                    </p>
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-[11px] font-bold text-solar uppercase tracking-widest">
                      {dev.time || dev.recommendation}
                    </p>
            ...
            <div className="space-y-6">
              ...
              {data.analysis?.alerts?.map((a, i) => (
                ...
                <div key={i} className="flex gap-4">
                  ...
                  <p className="text-[12px] text-gray-800 dark:text-gray-300 uppercase leading-relaxed italic font-medium tracking-tighter">
                    {a}
                  </p>
        ...
        <div className="mt-14 border-t border-gray-200 dark:border-white/10 pt-10 flex flex-col md:flex-row justify-between items-center gap-6 text-gray-500">
          ...
          <p className="text-[9px] uppercase tracking-[0.5em]">
            Solara Systems // Orbital Telemetry Build 1.0.4 [Render-Live]
          </p>
  ...
  return (
    <div className="border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/5 p-6 group hover:bg-white/10 transition-all cursor-default shadow-sm dark:shadow-none">
      ...
      <div className="flex items-baseline gap-2">
        ...
        <span className="text-[11px] text-gray-500 uppercase font-bold tracking-tighter">
          {unit}
        </span>
